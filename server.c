...
int main()
{
  ...
  while(1)
  {
		...
		{	
		 ...
		 strcpy(site1.site_name,"www.vid1.com");
		 strcpy(site1.site_desc,"iconic series: vid1  ");
		 ...
		 stat1.info_port = 5432; 
  		 stat1.bit_rate = 1087;
  		 strcpy(stat1.station_name,"vid1");
  		 
  		 /*Declaration of site info for station 2 */
  		 bzero(&site2,sizeof(site2));
  		 strcpy(site2.site_name,"www.vid2.com");
		 strcpy(site2.site_desc,"vid2 ");
       ...
       stat2.bit_rate = 891;
		 strcpy(stat2.station_name,"vid2");
